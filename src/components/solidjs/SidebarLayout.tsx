  ...
  return (
    <div class="relative flex max-h-full min-h-full flex-1 overflow-hidden">
      ...
      */}
      <label
        for="sidebar-toggle"
        class="peer/label absolute top-0 bottom-0 left-0 z-10 flex h-full w-[10px] cursor-e-resize items-center justify-center py-1 transition-all duration-200 peer-checked/checkbox:left-[256px] peer-checked/checkbox:cursor-w-resize peer-checked/checkbox:*:rounded-l-lg hover:w-[20px] peer-checked/checkbox:hover:left-[246px]"
      >
        <div class="dark:hover:bg-dark flex h-full w-full items-center justify-center rounded-lg rounded-l-none text-gray-500 hover:bg-white hover:shadow-md dark:hover:text-white">
          <i class="ti ti-grip-vertical text-xs" />
        </div>
      </label>
      ...
      */}
      <div class="absolute inset-y-0 left-0 w-[256px] -translate-x-full transform overflow-hidden p-1 transition-all duration-200 peer-checked/checkbox:translate-x-0 peer-hover/label:w-[246px]">
        {props.sidebar}
      </div>
      ...
      */}
      <div class="ml-[10px] flex-1 overflow-hidden p-1 transition-all duration-200 peer-checked/checkbox:ml-[266px] peer-hover/label:pl-[14px] peer-hover/label:peer-checked/checkbox:pl-1">
        {props.children}
      </div>
    </div>
  );
