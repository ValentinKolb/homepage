...
tags: ["Informatik", "Webentwicklung", "Astro", "Tailwind", "MDX"]
date: 2025-01-15
image: /images/blogs/2025-01-15/banner.jpg
---

import TicTacToe from "@/components/interactive/TicTacToe";
...
```html
<p class="m-2 text-xl text-blue-500">Mein schöner Text</p>
```
